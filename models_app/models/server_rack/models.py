...
class ServerRack(BaseModel):
    ...
    max_power = models.IntegerField(null=True, blank=True, verbose_name='Максимальная мощность')
    free_power = models.IntegerField(
        null=True, blank=True, verbose_name='Свободноя мощность', validators=[MinValueValidator(0)]
    )
    free_units = models.IntegerField(
        null=True, blank=True, verbose_name='Свободные юниты', validators=[MinValueValidator(0)]
    )
